...
function productionCreate(_, jsx14, jsxs12) {
  return create2;
  function create2(_2, type, props, key) {
    const isStaticChildren = Array.isArray(props.children);
    const fn = isStaticChildren ? jsxs12 : jsx14;
...
function SettingsCard() {
  ...
  const loadAccounts = (0, import_react9.useCallback)(() => {
    setStatus((prev) => ({ ...prev, accountsLoading: true }));
    fetch("/gitlab-tools/service-accounts", { cache: "no-store" }).then((r) => r.json()).then((json) => {
      setStatus((prev) => ({
        ...prev,
        accountsLoading: false,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { style: { boxSizing: "border-box", display: "flex", flexDirection: "column", gap: "12px", padding: "10px 10px 12px", overflowY: "auto", minHeight: "0", flex: "1 1 auto" }, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("label", { style: { display: "flex", flexDirection: "column", gap: "4px", fontSize: "11px", lineHeight: "16px", color: C.label2 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { children: "AI \u8EAB\u4EFD\uFF08\u670D\u52A1\u8D26\u6237\uFF09\u2014\u2014\u672C\u5BA2\u6237\u7AEF\u4EE5\u54EA\u4E2A\u8D26\u6237\u7684\u8EAB\u4EFD\u53D1\u8A00/\u54CD\u5E94\uFF08agent \u5DE5\u5177\u4E0E\u81EA\u52A8\u8D34\u56DE\u90FD\u7528\u5B83\uFF09" }),
      /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { style: { display: "flex", gap: "6px", alignItems: "center" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(
          "select",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("option", { value: "", children: "\u672A\u9009\u62E9\uFF08\u8DDF\u968F AI \u4E13\u5C5E token \u672C\u8EAB\uFF09" }),
              status.accounts.map((a) => /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("option", { value: a.username, children: "@" + a.username + (a.name ? " \xB7 " + a.name : "") + (a.hasToken ? "" : "\uFF08\u7F3A token\uFF09") }, a.username))
            ]
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
          "button",
          {
            ...
            children: status.accountsLoading ? "\u2026" : "\u5237\u65B0"
          }
        )
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { style: { fontSize: "10.5px", lineHeight: "15px", color: status.aiIdentityWarning ? C.err : C.caption }, children: status.aiIdentity ? "\u5F53\u524D\u751F\u6548\u8EAB\u4EFD\uFF1A@" + status.aiIdentity + (status.aiIdentityWarning ? "\u3000\u26A0 " + status.aiIdentityWarning : "") : "\u5C1A\u672A\u9009\u62E9\u8EAB\u4EFD\uFF1B\u9009\u62E9\u524D\u8BF7\u5148\u4E3A\u5BF9\u5E94\u8D26\u6237\u4FDD\u5B58 token\u3002\u5217\u8868\u4E3A\u7A7A\u65F6\u70B9\u300C\u5237\u65B0\u300D\u6216\u5148\u586B\u5165\u670D\u52A1\u8D26\u6237\u7684 token\u3002" })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
      TokenField,
      {
        title: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(import_jsx_runtime11.Fragment, { children: "AI \u4E13\u5C5E token\uFF08DeepSeek Harness \u8EAB\u4EFD\uFF09\u2014\u2014 \u4FDD\u5B58\u65F6\u6821\u9A8C\u5F52\u5C5E\u5E76\u7ED1\u5B9A\u5230\u5BF9\u5E94\u8D26\u6237\uFF1B agent \u5DE5\u5177\uFF08\u542B gitlab_create_note\uFF09\u4E0E\u81EA\u52A8\u8D34\u56DE\u90FD\u7528\u5B83\uFF0C\u4E0E\u4F60\u7684\u8EAB\u4EFD\u533A\u5206\uFF08scope \u81F3\u5C11 api\uFF09" }),
        value: cfg.aiToken,
...
function GitLabIssuesTab({ ctx, store, scope, visible }) {
  ...
  const [runningById, setRunningById] = (0, import_react10.useState)({});
  ...
  const isRunning = (0, import_react10.useCallback)((sessionId) => runningById[sessionId] === true, [runningById]);
  const onOpenSession = (0, import_react10.useCallback)((sessionId) => {
    ctx?.get?.("sessions")?.open?.(sessionId);
  }, [ctx]);
  const onStopSession = (0, import_react10.useCallback)(async (sessionId) => {
    try {
  ...
  const onDevSession = (0, import_react10.useCallback)(
    async (issue) => {
      if (busy) return;
      setBusy(true);
      try {
  ...
  const openNoticeSession = (0, import_react10.useCallback)(() => {
  ...
  if (selected) {
    return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(IssueDetailView, { project: selected.project, iid: selected.iid, onBack: () => setSelected(null) });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { style: rootPanelStyle, children: [
    /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { style: headerStyle, children: [
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("span", { style: { color: C.brand }, children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(IssueMark, { size: 14 }) }),
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("span", { style: { fontSize: "12.5px", fontWeight: 600, lineHeight: "18px", color: C.label1 }, children: showSettings ? "GitLab Issues \xB7 \u8BBE\u7F6E" : "GitLab Issues" }),
      !showSettings && /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("span", { style: { fontSize: "11px", color: C.label3, fontVariantNumeric: "tabular-nums" }, children: state.loading ? "\u5237\u65B0\u4E2D\u2026" : count }),
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("span", { style: { flex: "1 1 auto" } }),
      ...
      !showSettings && /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("button", { type: "button", title: "\u7ACB\u5373\u5237\u65B0", onClick: () => loadIssues(), style: iconBtnStyle, children: "\u27F3" })
    ] }),
    showSettings ? /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(SettingsCard, {}) : /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(import_jsx_runtime12.Fragment, { children: [
      notice ? /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(DevNoticePanel, { notice, onClose: () => setNotice(null), onOpenSession: openNoticeSession }) : null,
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(IssueFilter, { filters, onChange: setFilters }),
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
        IssueList,
        {
          state,
...
var TAB_DESCRIPTOR = {
  ...
  title: "GitLab Issues",
  icon: (size) => /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(IssueMark, { size }),
  order: 60,
  single: true,
