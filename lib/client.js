...
function GitLabIssuesTab({ ctx, scope, visible }) {
  ...
  const [runningById, setRunningById] = (0, import_react9.useState)({});
  ...
  const isRunning = (0, import_react9.useCallback)((sessionId) => runningById[sessionId] === true, [runningById]);
  const onOpenSession = (0, import_react9.useCallback)((sessionId) => {
    ctx?.get?.("sessions")?.open?.(sessionId);
  }, [ctx]);
  const onStopSession = (0, import_react9.useCallback)(async (sessionId) => {
    try {
  ...
  const onDevSession = (0, import_react9.useCallback)(
    async (issue) => {
      if (busy) return;
      setBusy(true);
      try {
  ...
  const openNoticeSession = (0, import_react9.useCallback)(() => {
  ...
  if (selected) {
    return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(IssueDetailView, { project: selected.project, iid: selected.iid, onBack: () => setSelected(null) });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { style: rootPanelStyle, children: [
    /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { style: headerStyle, children: [
      /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { style: { color: C.brand }, children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(IssueMark, { size: 14 }) }),
      /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { style: { fontSize: "12.5px", fontWeight: 600, lineHeight: "18px", color: C.label1 }, children: "GitLab Issues" }),
      /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { style: { fontSize: "11px", color: C.label3, fontVariantNumeric: "tabular-nums" }, children: state.loading ? "\u5237\u65B0\u4E2D\u2026" : count }),
      /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("button", { type: "button", title: "\u7ACB\u5373\u5237\u65B0", onClick: () => loadIssues(), style: iconBtnStyle, children: "\u27F3" })
    ] }),
    notice ? /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(DevNoticePanel, { notice, onClose: () => setNotice(null), onOpenSession: openNoticeSession }) : null,
    /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(IssueFilter, { filters, onChange: setFilters }),
...
function TokenField({ title, value, configured, placeholder, clear, clearLabel, onChange, onClearChange }) {
  return /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("label", { style: { display: "flex", flexDirection: "column", gap: "4px", fontSize: "11px", lineHeight: "16px", color: C.label2 }, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("label", { style: { display: "flex", alignItems: "center", gap: "6px", fontSize: "11px", lineHeight: "16px", color: C.label2 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
        "input",
        {
          type: "checkbox",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { children: clearLabel })
    ] })
  ] });
}
...
function SettingsCard() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: "12px", maxWidth: "560px" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: "8px" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("span", { style: { color: C.brand }, children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(IssueMark, { size: 16 }) }),
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("span", { style: { fontWeight: 600, fontSize: "13px", lineHeight: "20px", color: C.label1 }, children: "GitLab Issues \xB7 \u4FA7\u8FB9\u680F" }),
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("span", { style: { fontSize: "11px", lineHeight: "16px", color: status.configured ? C.ok : C.err }, children: status.loading ? "\u2026" : status.configured ? "\u5DF2\u914D\u7F6E" : "\u672A\u914D\u7F6E host/token" })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { style: { fontSize: "11px", lineHeight: "16px", color: C.label3 }, children: "\u670D\u52A1\u5668\u5730\u5740\uFF08host\uFF09\u5B58 settings\uFF1B\u8BBF\u95EE\u4EE4\u724C\uFF08token\uFF09\u5B58 DSH \u5B98\u65B9\u51ED\u636E\u5B58\u50A8 \uFF08~/.dsh/.credentials.yaml\uFF0C600 \u6743\u9650\uFF09\uFF0C\u53EA\u5199\u4E0D\u56DE\u663E\u660E\u6587\u3002\u7559\u7A7A\u4E14\u672A\u52FE\u9009 \u300C\u6E05\u9664\u300D\u5219\u4FDD\u6301\u4E0D\u53D8\uFF1B\u672A\u8BBE\u7F6E/\u88AB\u6E05\u9664\u65F6\u56DE\u843D profile patch config \u91CC\u7684\u503C\u3002 \u4FDD\u5B58\u540E\u7ACB\u5373\u751F\u6548\uFF08\u65E0\u9700\u91CD\u542F\uFF09\u3002" }),
    /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("label", { style: { display: "flex", flexDirection: "column", gap: "4px", fontSize: "11px", lineHeight: "16px", color: C.label2 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("span", { children: "\u670D\u52A1\u5668\u5730\u5740\uFF08GitLab base URL\uFF0C\u542B\u7AEF\u53E3\uFF0C\u5982 https://gitlab.example.com:8443\uFF09" }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
      TokenField,
      {
        title: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_jsx_runtime12.Fragment, { children: "AI \u4E13\u5C5E token\uFF08DeepSeek Harness \u8EAB\u4EFD\uFF0C\u53EF\u9009\uFF09\u2014\u2014 agent \u5DE5\u5177\uFF08\u542B gitlab_create_note\uFF09\u7528\u5B83\u53D1\u5E03\uFF0C \u4E0E\u4F60\u7684\u8EAB\u4EFD\u533A\u5206\uFF1B\u9700\u4F7F\u7528\u4E3A AI \u5EFA\u7684 Service Account \u7684 PAT\uFF08scope \u81F3\u5C11 api\uFF09" }),
        value: cfg.aiToken,
    ...
    /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("label", { style: { display: "flex", flexDirection: "column", gap: "4px", fontSize: "11px", lineHeight: "16px", color: C.label2 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("span", { children: "\u9ED8\u8BA4\u9879\u76EE\uFF08path_with_namespace\uFF0C\u5982 group/project\uFF1B\u7559\u7A7A\u5219\u4E0D\u5C55\u793A\uFF09" }),
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
        "input",
        {
          type: "text",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("label", { style: { display: "flex", flexDirection: "column", gap: "4px", fontSize: "11px", lineHeight: "16px", color: C.label2 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("span", { children: "\u9762\u677F\u81EA\u52A8\u5237\u65B0\u95F4\u9694" }),
      /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(
        "select",
        {
          ...
          style: inputStyle,
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("option", { value: 3e4, children: "30 \u79D2" }),
            /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("option", { value: 6e4, children: "1 \u5206\u949F" }),
            /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("option", { value: 12e4, children: "2 \u5206\u949F" }),
            /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("option", { value: 3e5, children: "5 \u5206\u949F" }),
            /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("option", { value: 6e5, children: "10 \u5206\u949F" })
          ]
        }
      )
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: "4px" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("span", { style: { fontSize: "11px", lineHeight: "16px", color: C.label2 }, children: "\u9879\u76EE \u2192 \u672C\u5730\u6587\u4EF6\u5939\u6620\u5C04" }),
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("span", { style: { fontSize: "10.5px", lineHeight: "15px", color: C.caption }, children: "\u521B\u5EFA\u5F00\u53D1\u4F1A\u8BDD\u65F6\u6309\u6B64\u628A\u4F1A\u8BDD\u653E\u8FDB\u5BF9\u5E94\u9879\u76EE\u7684\u5DE5\u4F5C\u533A\u5206\u7EC4\uFF08\u5DE6\u4FA7\u586B\u9879\u76EE path\uFF0C\u5982 group/project\uFF1B\u53F3\u4FA7\u586B\u672C\u5730\u6587\u4EF6\u5939\u8DEF\u5F84\uFF09\u3002" }),
      cfg.projectDirs.map((row, i) => /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { style: { display: "flex", gap: "6px", alignItems: "center" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
          "input",
          {
            type: "text",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: "8px" }, children: [
      ...
      status.msg ? /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("span", { style: { fontSize: "11px", color: C.label3 }, children: status.msg }) : null
    ] }),
    status.test ? /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { style: { fontSize: "11px", lineHeight: "16px", color: status.test.ok ? C.ok : C.err }, children: status.test.text }) : null
  ] });
}
