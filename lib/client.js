...
function buildPrompt(issue, project, cwd) {
  ...
  return [
    ...
    cwd ? `\u82E5\u5F53\u524D\u5DE5\u4F5C\u76EE\u5F55\u4E0D\u662F ${project || "\u8BE5\u9879\u76EE"} \u7684\u672C\u5730\u4ED3\u5E93\uFF0C\u5148 git clone \u5230\u5408\u9002\u4F4D\u7F6E\u518D\u52A8\u624B\u3002` : "\u5F53\u524D\u6CA1\u6709\u5DE5\u4F5C\u76EE\u5F55\uFF1A\u5148\u786E\u5B9A/\u514B\u9686\u8BE5\u9879\u76EE\u5230\u5408\u9002\u7684\u5DE5\u4F5C\u76EE\u5F55\uFF0C\u518D\u5F00\u59CB\u5B9E\u73B0\u3002",
...
async function createDevSession(ctx, scope, issue, project) {
...
function useIssueDetail(project, iid) {
  const [state, setState] = (0, import_react.useState)({ loading: true, issue: null, notes: [], error: null });
...
\u67E5\u770B\u8BE6\u60C5\u4E0E\u8BA8\u8BBA`,
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { fontSize: "12.5px", lineHeight: "18px", fontWeight: 500, color: C.label1 }, children: issue.title || `(untitled #${issue.iid})` }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: metaStyle, children: [
                ...
                issue.labels.slice(0, 3).map((l) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { style: chipStyle, children: l }, l)),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          "button",
          {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(DevSessionMark, { size: 14 })
          }
        )
      ]
    }
...
function IssueList({ state, onOpen, onDevSession }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: listStyle, children: errorText ? /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: hintStyle, children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { color: C.err, fontWeight: 500 }, children: errorText }),
    state.data?.code === "no_project" ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { marginTop: "4px" }, children: "\u8BF7\u5230 \u8BBE\u7F6E \u2192 GitLab Issues \u914D\u7F6E\u9879\u76EE\u3002" }) : null
  ] }) : issues.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: hintStyle, children: state.loading ? "\u52A0\u8F7D\u4E2D\u2026" : "\u6CA1\u6709\u6253\u5F00\u7684 issue\u3002" }) : issues.map((i) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(IssueRow, { issue: i, onOpen, onDevSession }, i.iid)) });
}
...
function NoteRow({ note, links }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: { display: "flex", gap: "8px", padding: "6px 0" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { style: avatarStyle, children: initial }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: { flex: "1", minWidth: "0" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: { display: "flex", alignItems: "baseline", gap: "6px" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { style: { fontSize: "11.5px", fontWeight: 600, color: C.label1 }, children: author }),
        note.system ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { style: { fontSize: "10px", color: C.brand }, children: "\u7CFB\u7EDF" }) : null,
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { style: { fontSize: "10px", color: C.caption }, children: fmtRelative(note.created_at) })
      ] }),
...
function IssueDetailView({ project, iid, onBack }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: rootPanelStyle, children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: "4px", padding: "5px 8px", borderBottom: `1px solid ${C.borderThin}`, flex: "none" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { type: "button", title: "\u8FD4\u56DE\u5217\u8868", onClick: onBack, style: iconBtnStyle, children: "\u2190" }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { style: { fontSize: "12px", fontWeight: 600, color: C.label1, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis", flex: "1", minWidth: "0" }, children: issue ? issue.title : `#${iid}` }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { style: { fontSize: "10.5px", color: C.caption, whiteSpace: "nowrap" }, children: project }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { type: "button", title: "\u5237\u65B0\u8BE6\u60C5\u4E0E\u8BA8\u8BBA", onClick: load, style: iconBtnStyle, children: "\u27F3" })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { style: { flex: "1", minHeight: "0", overflowY: "auto" }, children: state.loading && !issue ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { style: hintStyle, children: "\u52A0\u8F7D\u4E2D\u2026" }) : state.error && !issue ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { style: { ...hintStyle, color: C.err }, children: state.error }) : issue ? /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: { padding: "8px 10px", borderBottom: `1px solid ${C.borderThin}` }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { style: { fontSize: "13px", lineHeight: "19px", fontWeight: 600, color: C.label1 }, children: issue.title }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: { ...metaStyle, marginTop: "4px" }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { style: { color: issue.state === "opened" ? C.ok : C.label3, whiteSpace: "nowrap" }, children: [
            "#",
            issue.iid,
            " \xB7 ",
            issue.state
          ] }),
          issue.labels.slice(0, 5).map((l) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { style: chipStyle, children: l }, l)),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { style: { color: C.caption, whiteSpace: "nowrap" }, children: [
            "\u4F5C\u8005 @",
        ...
        issue.milestone ? /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: { fontSize: "11px", color: C.caption, marginTop: "2px" }, children: [
          "\u91CC\u7A0B\u7891\uFF1A",
          issue.milestone.title
        ] }) : null,
        issue.web_url ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
          "a",
          {
            href: issue.web_url,
            target: "_blank",
      ...
      issue.description ? /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: { padding: "8px 10px", borderBottom: `1px solid ${C.borderThin}` }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { style: { fontSize: "11px", color: C.caption, marginBottom: "4px" }, children: "\u63CF\u8FF0" }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "gt-md", dangerouslySetInnerHTML: { __html: renderMarkdown(issue.description, links) } })
      ] }) : null,
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: { padding: "8px 10px" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: { fontSize: "11px", color: C.caption, marginBottom: "4px" }, children: [
          "\u8BA8\u8BBA \xB7 ",
          state.notes.length
        ] }),
        state.notes.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { style: { fontSize: "12px", color: C.label3 }, children: "\u8FD8\u6CA1\u6709\u8BC4\u8BBA\u3002" }) : state.notes.map((n) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(NoteRow, { note: n, links }, n.id))
      ] })
    ] }) : null }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: { flex: "none", padding: "8px", borderTop: `1px solid ${C.borderThin}` }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
        "textarea",
        {
          value: draft,
      ...
      postError ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { style: { color: C.err, fontSize: "11px", marginTop: "4px" }, children: postError }) : null,
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: { display: "flex", justifyContent: "flex-end", gap: "6px", marginTop: "6px" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { style: { fontSize: "10.5px", color: C.caption, alignSelf: "center" }, children: "\u4F60\u7684\u8BC4\u8BBA\u4EE5\u914D\u7F6E\u8D26\u53F7\u53D1\u5E03\uFF1BAI \u8BC4\u8BBA\u8D70\u4E13\u5C5E Service Account\uFF08\u82E5\u5DF2\u914D\u7F6E\uFF09" }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { type: "button", onClick: () => void submit(), disabled: posting || !draft.trim(), style: primaryBtnStyle, children: posting ? "\u53D1\u9001\u4E2D\u2026" : "\u53D1\u8868\u8BC4\u8BBA" })
      ] })
    ] })
  ] });
}
...
function GitLabIssuesTab({ ctx, scope, visible }) {
  ...
  const onDevSession = (0, import_react4.useCallback)(
    async (issue) => {
      if (busy) return;
      setBusy(true);
      try {
  ...
  const openNoticeSession = (0, import_react4.useCallback)(() => {
  ...
  if (selected) {
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(IssueDetailView, { project: selected.project, iid: selected.iid, onBack: () => setSelected(null) });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: rootPanelStyle, children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: headerStyle, children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { style: { color: C.brand }, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(IssueMark, { size: 14 }) }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { style: { fontSize: "12.5px", fontWeight: 600, lineHeight: "18px", color: C.label1 }, children: "GitLab Issues" }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { style: { fontSize: "11px", color: C.label3, fontVariantNumeric: "tabular-nums" }, children: state.loading ? "\u5237\u65B0\u4E2D\u2026" : count }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { type: "button", title: "\u7ACB\u5373\u5237\u65B0", onClick: () => loadIssues(), style: iconBtnStyle, children: "\u27F3" })
    ] }),
    notice ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: noticeStyle, children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: { display: "flex", alignItems: "flex-start", gap: "6px" }, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { type: "button", title: "\u5173\u95ED", onClick: () => setNotice(null), style: iconBtnStyle, children: "\u2715" })
      ] }),
      notice.prompt ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
        "div",
        {
          style: {
            marginTop: "6px",
      ...
      notice.prompt || notice.sessionId ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: { display: "flex", gap: "6px", marginTop: "6px" }, children: [
        notice.prompt ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
          "button",
          {
            type: "button",
        ...
        notice.sessionId ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { type: "button", onClick: openNoticeSession, style: miniBtnStyle, children: "\u6253\u5F00\u4F1A\u8BDD" }) : null
      ] }) : null
    ] }) : null,
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(IssueList, { state, onOpen, onDevSession }),
...
function SettingsCard() {
  const [cfg, setCfg] = (0, import_react5.useState)({
    defaultProject: "",
    host: "",
    token: "",
    clearToken: false,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: "12px", maxWidth: "560px" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: "8px" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { style: { color: C.brand }, children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(IssueMark, { size: 16 }) }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { style: { fontWeight: 600, fontSize: "13px", lineHeight: "20px", color: C.label1 }, children: "GitLab Issues \xB7 \u4FA7\u8FB9\u680F" }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { style: { fontSize: "11px", lineHeight: "16px", color: status.configured ? C.ok : C.err }, children: status.loading ? "\u2026" : status.configured ? "\u5DF2\u914D\u7F6E" : "\u672A\u914D\u7F6E host/token" })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { style: { fontSize: "11px", lineHeight: "16px", color: C.label3 }, children: "\u670D\u52A1\u5668\u5730\u5740\uFF08host\uFF09\u5B58 settings\uFF1B\u8BBF\u95EE\u4EE4\u724C\uFF08token\uFF09\u5B58 DSH \u5B98\u65B9\u51ED\u636E\u5B58\u50A8 \uFF08~/.dsh/.credentials.yaml\uFF0C600 \u6743\u9650\uFF09\uFF0C\u53EA\u5199\u4E0D\u56DE\u663E\u660E\u6587\u3002\u7559\u7A7A\u4E14\u672A\u52FE\u9009 \u300C\u6E05\u9664\u300D\u5219\u4FDD\u6301\u4E0D\u53D8\uFF1B\u672A\u8BBE\u7F6E/\u88AB\u6E05\u9664\u65F6\u56DE\u843D profile patch config \u91CC\u7684\u503C\u3002 \u4FDD\u5B58\u540E\u7ACB\u5373\u751F\u6548\uFF08\u65E0\u9700\u91CD\u542F\uFF09\u3002" }),
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("label", { style: { display: "flex", flexDirection: "column", gap: "4px", fontSize: "11px", lineHeight: "16px", color: C.label2 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { children: "\u670D\u52A1\u5668\u5730\u5740\uFF08GitLab base URL\uFF0C\u542B\u7AEF\u53E3\uFF0C\u5982 https://gitlab.example.com:8443\uFF09" }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("label", { style: { display: "flex", flexDirection: "column", gap: "4px", fontSize: "11px", lineHeight: "16px", color: C.label2 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { children: "\u8BBF\u95EE\u4EE4\u724C\uFF08Personal Access Token\uFF1B\u53EA\u5199\u4E0D\u56DE\u663E\uFF09" }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
        "input",
        {
          type: "password",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("label", { style: { display: "flex", alignItems: "center", gap: "6px", fontSize: "11px", lineHeight: "16px", color: C.label2 }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
          "input",
          {
            type: "checkbox",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { children: "\u6E05\u9664\u5DF2\u4FDD\u5B58\u7684 token\uFF08\u56DE\u843D profile patch config\uFF09" })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("label", { style: { display: "flex", flexDirection: "column", gap: "4px", fontSize: "11px", lineHeight: "16px", color: C.label2 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { children: "AI \u4E13\u5C5E token\uFF08DeepSeek Harness \u8EAB\u4EFD\uFF0C\u53EF\u9009\uFF09\u2014\u2014 agent \u5DE5\u5177\uFF08\u542B gitlab_create_note\uFF09\u7528\u5B83\u53D1\u5E03\uFF0C \u4E0E\u4F60\u7684\u8EAB\u4EFD\u533A\u5206\uFF1B\u9700\u4F7F\u7528\u4E3A AI \u5EFA\u7684 Service Account \u7684 PAT\uFF08scope \u81F3\u5C11 api\uFF09" }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
        "input",
        {
          type: "password",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("label", { style: { display: "flex", alignItems: "center", gap: "6px", fontSize: "11px", lineHeight: "16px", color: C.label2 }, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { children: "\u6E05\u9664 AI \u4E13\u5C5E token\uFF08\u56DE\u843D profile patch config\uFF09" })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("label", { style: { display: "flex", flexDirection: "column", gap: "4px", fontSize: "11px", lineHeight: "16px", color: C.label2 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { children: "\u9ED8\u8BA4\u9879\u76EE\uFF08path_with_namespace\uFF0C\u5982 group/project\uFF1B\u7559\u7A7A\u5219\u4E0D\u5C55\u793A\uFF09" }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
        "input",
        {
          type: "text",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("label", { style: { display: "flex", flexDirection: "column", gap: "4px", fontSize: "11px", lineHeight: "16px", color: C.label2 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { children: "\u9762\u677F\u81EA\u52A8\u5237\u65B0\u95F4\u9694" }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
        "select",
        {
          ...
          style: inputStyle,
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("option", { value: 3e4, children: "30 \u79D2" }),
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("option", { value: 6e4, children: "1 \u5206\u949F" }),
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("option", { value: 12e4, children: "2 \u5206\u949F" }),
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("option", { value: 3e5, children: "5 \u5206\u949F" }),
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("option", { value: 6e5, children: "10 \u5206\u949F" })
          ]
        }
      )
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: "8px" }, children: [
      ...
      status.msg ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { style: { fontSize: "11px", color: C.label3 }, children: status.msg }) : null
    ] }),
    status.test ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { style: { fontSize: "11px", lineHeight: "16px", color: status.test.ok ? C.ok : C.err }, children: status.test.text }) : null
  ] });
}
...
var TAB_DESCRIPTOR = {
  ...
  title: "GitLab Issues",
  icon: (size) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(IssueMark, { size }),
  order: 60,
  single: true,
