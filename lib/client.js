...
function resolveWorkspaceId(ctx, cwd2) {
...
function buildPrompt(issue, project, cwd2, context) {
  ...
  return [
    ...
    "0. \u3010\u53EA\u8BFB\u8C03\u7814\xB7\u4E0D\u5199\u4EE3\u7801\u3011\u57FA\u4E8E\u4E0A\u9762\u5DF2\u5185\u5D4C\u7684 issue \u6B63\u6587\u4E0E\u8BA8\u8BBA\uFF08\u4E0D\u5FC5\u518D gitlab_view_issue / gitlab_list_notes \u91CD\u590D\u62C9\u53D6\uFF09\uFF0C" + (cwd2 ? `clone/\u5B9A\u4F4D\u4ED3\u5E93\u540E\uFF0C\u8BC4\u4F30\u3010\u8BE5 issue \u4E0E\u5F53\u524D\u4EE3\u7801\u7684\u5339\u914D\u7A0B\u5EA6\u3011\uFF1A\u9700\u6C42\u80FD\u843D\u5728\u54EA\u4E9B\u73B0\u6709\u6A21\u5757/\u4EE3\u7801\u8DEF\u5F84\u4E0A\u3001\u6539\u52A8\u8303\u56F4\u5927\u6982\u591A\u5927\u3002` : `\u8BC4\u4F30\u8BE5 issue \u4E0E\u4EE3\u7801\u7684\u5339\u914D\u7A0B\u5EA6\uFF1A\u5148\u786E\u5B9A/\u514B\u9686\u8BE5\u9879\u76EE\u5230\u5408\u9002\u5DE5\u4F5C\u76EE\u5F55\u3002`) + " \u8FD9\u4E00\u6B65\u53EA\u8C03\u7814\uFF0C\u7EDD\u4E0D\u5F00\u59CB\u5199\u4EE3\u7801\u3002",
...
async function createDevSession(ctx, scope, issue, project, projectDirs) {
  ...
  const cwd2 = mapped?.dir && mapped.dir.trim() || scope?.cwd;
  const suitable = typeof cwd2 === "string" && cwd2.trim() !== "";
  const prompt = buildPrompt(issue, project, cwd2, context);
  try {
    if (!suitable) {
      return {
        kind: "warn",
    ...
    const workspaceId = resolveWorkspaceId(ctx, cwd2);
    const sessionId = await sessions.create(workspaceId ? { workspaceId } : { cwd: cwd2 });
...
// src/client/use-panel.ts
var DEFAULT_FILTERS = { search: "", scope: "assigned_to_me" };
function issueQuery(filters, project) {
...
function usePanel(active = true, overrides = {}) {
  const [settings, setSettings] = (0, import_react.useState)(null);
  const [state, setState] = (0, import_react.useState)({ loading: true, data: null, error: null });
  const [filters, setFiltersState] = (0, import_react.useState)(DEFAULT_FILTERS);
  const overridesRef = (0, import_react.useRef)(overrides);
  overridesRef.current = overrides;
  const filtersRef = (0, import_react.useRef)(filters);
  filtersRef.current = filters;
  const loadIssues = (0, import_react.useCallback)((project, f) => {
    const eff = f ?? filtersRef.current;
    setState((prev) => ({ loading: true, data: prev.data, error: null }));
    fetch(`/gitlab-tools/issues${issueQuery(eff, project)}`, { cache: "no-store" }).then((r) => r.json()).then((json) => {
      setState({
        loading: false,
        data: json,
  ...
  const setFilters = (0, import_react.useCallback)((patch2) => {
    setFiltersState((prev) => ({ ...prev, ...patch2 }));
  }, []);
  const loadSettings = (0, import_react.useCallback)(() => {
    fetch("/gitlab-tools/settings", { cache: "no-store" }).then((r) => r.json()).then((json) => {
      ...
      setSettings((prev) => {
        ...
        const next = {
          defaultProject: typeof ov.defaultProject === "string" && ov.defaultProject.trim() !== "" ? ov.defaultProject : json.defaultProject ?? "",
          refreshMs: typeof ov.refreshMs === "number" ? ov.refreshMs : json.refreshMs ?? 12e4,
  ...
  (0, import_react.useEffect)(() => {
    ...
    const t = window.setTimeout(() => loadIssues(void 0, filters), delay);
    return () => window.clearTimeout(t);
  }, [active, filters, loadIssues]);
  (0, import_react.useEffect)(() => {
    if (!active) return;
    loadSettings();
    loadIssues(void 0, filtersRef.current);
    let timer;
    const schedule = () => {
...
function useIssueDetail(project, iid) {
  ...
  const post2 = (0, import_react4.useCallback)(
    async (text7) => {
      const t = text7.trim();
  ...
  return { state, posting, postError, load, post: post2 };
}
...
// node_modules/.pnpm/react-markdown@10.1.0_@types+react@19.2.18_react@19.2.8/node_modules/react-markdown/index.js
init_define_import_meta_env();

// node_modules/.pnpm/react-markdown@10.1.0_@types+react@19.2.18_react@19.2.8/node_modules/react-markdown/lib/index.js
init_define_import_meta_env();
...
function productionCreate(_, jsx16, jsxs14) {
  return create2;
  function create2(_2, type, props, key) {
    const isStaticChildren = Array.isArray(props.children);
    const fn = isStaticChildren ? jsxs14 : jsx16;
...
function sanitizeSystemHtml(html5) {
  return html5.replace(/<(\/?)([a-zA-Z0-9]+)((?:\s+[a-zA-Z0-9-]+(?:\s*=\s*(?:"[^"]*"|'[^']*'|[^\s>]+))?)*)\s*(\/?)>/g, (m, close, tag, attrs, selfclose) => {
    if (!SAFE_TAGS.has(tag.toLowerCase())) return "";
    let keep = "";
    const attrRe = /([a-zA-Z0-9-]+)(?:\s*=\s*(?:"([^"]*)"|'([^']*)'|([^\s>]+)))?/g;
    let am;
    while (am = attrRe.exec(attrs)) {
      const name2 = am[1].toLowerCase();
      const val = (am[2] ?? am[3] ?? am[4] ?? "").replace(/"/g, "");
      if (name2 === "class") keep += ` class="${val}"`;
      else if (name2 === "href") {
        const v = val.trim().toLowerCase();
        if (/^(https?:|mailto:|#|\/)/.test(v)) keep += ` href="${val}"`;
      } else if (name2 === "title") keep += ` title="${val}"`;
    }
  ...
  return (tree) => {
    ...
    visit(tree, "text", (node2, index2, parent) => {
      ...
      const children = parts.map(
        (p) => p.url ? { type: "link", url: p.url, title: null, children: [{ type: "text", value: p.text }] } : { type: "text", value: p.text }
      );
      parent.children.splice(index2, 1, ...children);
      return index2 + children.length;
    });
  };
}
var components = {
  a({ node: _node, ...props }) {
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("a", { ...props, target: "_blank", rel: "noopener noreferrer" });
  }
};
function Markdown2({ text: text7, links, className = "gt-md" }) {
  const plugins = (0, import_react6.useMemo)(
    () => [remarkGfm, [remarkGitlabLinks, links]],
    [links]
  );
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className, children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Markdown, { remarkPlugins: plugins, components, children: text7 }) });
}
function isSystemHtml(body) {
  return /<[a-zA-Z][^>]*>/.test(body);
}
function systemNoteHtml(body) {
...
function Avatar({ src, initial, title }) {
  const [failed, setFailed] = (0, import_react7.useState)(false);
  if (!src || failed) {
    return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { style: avatarStyle, title, children: initial });
  }
...
function NoteRow({ note, links }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: { display: "flex", gap: "8px", padding: "6px 0" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Avatar, { src: note.author?.avatar_url ?? null, initial, title: author }),
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: { flex: "1", minWidth: "0" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: { display: "flex", alignItems: "baseline", gap: "6px" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { style: { fontSize: "11.5px", fontWeight: 600, color: C.label1 }, children: author }),
        note.system ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { style: { fontSize: "10px", color: C.brand }, children: "\u7CFB\u7EDF" }) : null,
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { style: { fontSize: "10px", color: C.caption }, children: fmtRelative(note.created_at) })
      ] }),
      systemHtml !== null ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "gt-md", style: { marginTop: "2px" }, dangerouslySetInnerHTML: { __html: systemHtml } }) : /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { style: { marginTop: "2px" }, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Markdown2, { text: body, links }) })
    ] })
  ] });
}
...
function IssueDetailView({ project, iid, onBack }) {
  const { state, posting, postError, load, post: post2 } = useIssueDetail(project, iid);
  ...
  const submit = async () => {
    ...
    const err = await post2(draft);
    if (!err) setDraft("");
  };
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { style: rootPanelStyle, children: [
    /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: "4px", padding: "5px 8px", borderBottom: `1px solid ${C.borderThin}`, flex: "none" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("button", { type: "button", title: "\u8FD4\u56DE\u5217\u8868", onClick: onBack, style: iconBtnStyle, children: "\u2190" }),
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { style: { fontSize: "12px", fontWeight: 600, color: C.label1, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis", flex: "1", minWidth: "0" }, children: issue ? issue.title : `#${iid}` }),
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { style: { fontSize: "10.5px", color: C.caption, whiteSpace: "nowrap" }, children: project }),
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("button", { type: "button", title: "\u5237\u65B0\u8BE6\u60C5\u4E0E\u8BA8\u8BBA", onClick: load, style: iconBtnStyle, children: "\u27F3" })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { style: { flex: "1", minHeight: "0", overflowY: "auto" }, children: state.loading && !issue ? /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { style: hintStyle, children: "\u52A0\u8F7D\u4E2D\u2026" }) : state.error && !issue ? /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { style: { ...hintStyle, color: C.err }, children: state.error }) : issue ? /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(import_jsx_runtime7.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { style: { padding: "8px 10px", borderBottom: `1px solid ${C.borderThin}` }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { style: { fontSize: "13px", lineHeight: "19px", fontWeight: 600, color: C.label1 }, children: issue.title }),
        /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { style: { ...metaStyle, marginTop: "4px" }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("span", { style: { color: issue.state === "opened" ? C.ok : C.label3, whiteSpace: "nowrap" }, children: [
            "#",
            issue.iid,
            " \xB7 ",
            issue.state
          ] }),
          issue.labels.slice(0, 5).map((l) => /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { style: labelChipStyle(l), children: l.name }, l.name)),
          /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("span", { style: { color: C.caption, whiteSpace: "nowrap" }, children: [
            "\u4F5C\u8005 @",
        ...
        issue.milestone ? /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { style: { fontSize: "11px", color: C.caption, marginTop: "2px" }, children: [
          "\u91CC\u7A0B\u7891\uFF1A",
          issue.milestone.title
        ] }) : null,
        issue.web_url ? /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
          "a",
          {
            href: issue.web_url,
            target: "_blank",
      ...
      issue.description ? /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { style: { padding: "8px 10px", borderBottom: `1px solid ${C.borderThin}` }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { style: { fontSize: "11px", color: C.caption, marginBottom: "4px" }, children: "\u63CF\u8FF0" }),
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Markdown2, { text: issue.description, links })
      ] }) : null,
      /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { style: { padding: "8px 10px" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { style: { fontSize: "11px", color: C.caption, marginBottom: "4px" }, children: [
          "\u8BA8\u8BBA \xB7 ",
          state.notes.length
        ] }),
        state.notes.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { style: { fontSize: "12px", color: C.label3 }, children: "\u8FD8\u6CA1\u6709\u8BC4\u8BBA\u3002" }) : state.notes.map((n) => /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(NoteRow, { note: n, links }, n.id))
      ] })
    ] }) : null }),
    /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { style: { flex: "none", padding: "8px", borderTop: `1px solid ${C.borderThin}` }, children: [
      ...
      postError ? /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { style: { color: C.err, fontSize: "11px", marginTop: "4px" }, children: postError }) : null,
      /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { style: { display: "flex", justifyContent: "flex-end", gap: "6px", marginTop: "6px" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { style: { fontSize: "10.5px", color: C.caption, alignSelf: "center" }, children: "\u4F60\u7684\u8BC4\u8BBA\u4EE5\u914D\u7F6E\u8D26\u53F7\u53D1\u5E03\uFF1BAI \u8BC4\u8BBA\u8D70\u4E13\u5C5E Service Account\uFF08\u82E5\u5DF2\u914D\u7F6E\uFF09" }),
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("button", { type: "button", onClick: () => void submit(), disabled: posting || !draft.trim(), style: primaryBtnStyle, children: posting ? "\u53D1\u9001\u4E2D\u2026" : "\u53D1\u8868\u8BC4\u8BBA" })
      ] })
    ] })
  ] });
}

// src/client/issue-filter.tsx
init_define_import_meta_env();
var import_jsx_runtime8 = require("react/jsx-runtime");
function IssueFilter({ filters, onChange }) {
...
function DevNoticePanel({ notice, onClose, onOpenSession }) {
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { style: noticeStyle, children: [
    /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { style: { display: "flex", alignItems: "flex-start", gap: "6px" }, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("button", { type: "button", title: "\u5173\u95ED", onClick: onClose, style: iconBtnStyle, children: "\u2715" })
    ] }),
    notice.prompt ? /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
      "div",
      {
        style: {
          marginTop: "6px",
    ...
    notice.prompt || notice.sessionId ? /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { style: { display: "flex", gap: "6px", marginTop: "6px" }, children: [
      notice.prompt ? /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
        "button",
        {
          type: "button",
      ...
      notice.sessionId ? /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("button", { type: "button", onClick: onOpenSession, style: miniBtnStyle, children: "\u6253\u5F00\u4F1A\u8BDD" }) : null
    ] }) : null
  ] });
}
...
function TokenField({ title, value, configured, placeholder, clear, clearLabel, onChange, onClearChange }) {
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("label", { style: { display: "flex", flexDirection: "column", gap: "4px", fontSize: "11px", lineHeight: "16px", color: C.label2 }, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("label", { style: { display: "flex", alignItems: "center", gap: "6px", fontSize: "11px", lineHeight: "16px", color: C.label2 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
        "input",
        {
          type: "checkbox",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { children: clearLabel })
    ] })
  ] });
}
...
function SettingsCard() {
  const [cfg, setCfg] = (0, import_react9.useState)({
    defaultProject: "",
    host: "",
    token: "",
    clearToken: false,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { style: { boxSizing: "border-box", display: "flex", flexDirection: "column", gap: "12px", padding: "10px 10px 12px", overflowY: "auto", minHeight: "0", flex: "1 1 auto" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: "8px" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { style: { color: C.brand }, children: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(IssueMark, { size: 16 }) }),
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { style: { fontWeight: 600, fontSize: "13px", lineHeight: "20px", color: C.label1 }, children: "GitLab Issues \xB7 \u4FA7\u8FB9\u680F" }),
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { style: { fontSize: "11px", lineHeight: "16px", color: status.configured ? C.ok : C.err }, children: status.loading ? "\u2026" : status.configured ? "\u5DF2\u914D\u7F6E" : "\u672A\u914D\u7F6E host/token" })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { style: { fontSize: "11px", lineHeight: "16px", color: C.label3 }, children: "\u670D\u52A1\u5668\u5730\u5740\uFF08host\uFF09\u5B58 settings\uFF1B\u8BBF\u95EE\u4EE4\u724C\uFF08token\uFF09\u5B58 DSH \u5B98\u65B9\u51ED\u636E\u5B58\u50A8 \uFF08~/.dsh/.credentials.yaml\uFF0C600 \u6743\u9650\uFF09\uFF0C\u53EA\u5199\u4E0D\u56DE\u663E\u660E\u6587\u3002\u7559\u7A7A\u4E14\u672A\u52FE\u9009 \u300C\u6E05\u9664\u300D\u5219\u4FDD\u6301\u4E0D\u53D8\uFF1B\u672A\u8BBE\u7F6E/\u88AB\u6E05\u9664\u65F6\u56DE\u843D profile patch config \u91CC\u7684\u503C\u3002 \u4FDD\u5B58\u540E\u7ACB\u5373\u751F\u6548\uFF08\u65E0\u9700\u91CD\u542F\uFF09\u3002" }),
    /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("label", { style: { display: "flex", flexDirection: "column", gap: "4px", fontSize: "11px", lineHeight: "16px", color: C.label2 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { children: "\u670D\u52A1\u5668\u5730\u5740\uFF08GitLab base URL\uFF0C\u542B\u7AEF\u53E3\uFF0C\u5982 https://gitlab.example.com:8443\uFF09" }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
      TokenField,
      {
        title: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(import_jsx_runtime11.Fragment, { children: "AI \u4E13\u5C5E token\uFF08DeepSeek Harness \u8EAB\u4EFD\uFF0C\u53EF\u9009\uFF09\u2014\u2014 agent \u5DE5\u5177\uFF08\u542B gitlab_create_note\uFF09\u7528\u5B83\u53D1\u5E03\uFF0C \u4E0E\u4F60\u7684\u8EAB\u4EFD\u533A\u5206\uFF1B\u9700\u4F7F\u7528\u4E3A AI \u5EFA\u7684 Service Account \u7684 PAT\uFF08scope \u81F3\u5C11 api\uFF09" }),
        value: cfg.aiToken,
    ...
    /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("label", { style: { display: "flex", flexDirection: "column", gap: "4px", fontSize: "11px", lineHeight: "16px", color: C.label2 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { children: "\u9ED8\u8BA4\u9879\u76EE\uFF08path_with_namespace\uFF0C\u5982 group/project\uFF1B\u7559\u7A7A\u5219\u4E0D\u5C55\u793A\uFF09" }),
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
        "input",
        {
          type: "text",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("label", { style: { display: "flex", flexDirection: "column", gap: "4px", fontSize: "11px", lineHeight: "16px", color: C.label2 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { children: "\u9762\u677F\u81EA\u52A8\u5237\u65B0\u95F4\u9694" }),
      /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(
        "select",
        {
          ...
          style: inputStyle,
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("option", { value: 3e4, children: "30 \u79D2" }),
            /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("option", { value: 6e4, children: "1 \u5206\u949F" }),
            /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("option", { value: 12e4, children: "2 \u5206\u949F" }),
            /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("option", { value: 3e5, children: "5 \u5206\u949F" }),
            /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("option", { value: 6e5, children: "10 \u5206\u949F" })
          ]
        }
      )
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: "4px" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { style: { fontSize: "11px", lineHeight: "16px", color: C.label2 }, children: "\u9879\u76EE \u2192 \u672C\u5730\u6587\u4EF6\u5939\u6620\u5C04" }),
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { style: { fontSize: "10.5px", lineHeight: "15px", color: C.caption }, children: "\u521B\u5EFA\u5F00\u53D1\u4F1A\u8BDD\u65F6\u6309\u6B64\u628A\u4F1A\u8BDD\u653E\u8FDB\u5BF9\u5E94\u9879\u76EE\u7684\u5DE5\u4F5C\u533A\u5206\u7EC4\uFF08\u5DE6\u4FA7\u586B\u9879\u76EE path\uFF0C\u5982 group/project\uFF1B\u53F3\u4FA7\u586B\u672C\u5730\u6587\u4EF6\u5939\u8DEF\u5F84\uFF09\u3002" }),
      cfg.projectDirs.map((row, i) => /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { style: { display: "flex", gap: "6px", alignItems: "center" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
          "input",
          {
            type: "text",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: "8px" }, children: [
      ...
      status.msg ? /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { style: { fontSize: "11px", color: C.label3 }, children: status.msg }) : null
    ] }),
    status.test ? /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { style: { fontSize: "11px", lineHeight: "16px", color: status.test.ok ? C.ok : C.err }, children: status.test.text }) : null
  ] });
}

// src/client/agent-events.tsx
init_define_import_meta_env();
...
function Badge({ children, tone = "neutral" }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("span", { style: { ...badgeBase, ...t }, children });
}
function Btn({ children, onClick, disabled, title, active }) {
  const base = {
    padding: "3px 8px",
    borderRadius: "8px",
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("button", { type: "button", title, onClick, disabled, style: { ...base, ...disabled ? { opacity: 0.5, cursor: "default" } : {} }, children });
}
function StatusCard({ children }) {
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { style: { display: "flex", flexDirection: "column", gap: "3px", padding: "8px 10px", borderRadius: "8px", background: C.surface, border: "1px solid " + C.border }, children });
}
function StatusRow({ label, value, warn }) {
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { style: { display: "flex", gap: "8px", fontSize: "11px", lineHeight: "17px" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("span", { style: { color: C.label3, flex: "0 0 64px" }, children: label }),
    /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("span", { style: { color: warn ? C.err : C.label1, wordBreak: "break-all" }, children: value })
  ] });
}
function Row({ children }) {
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { style: { display: "flex", flexDirection: "column", gap: "2px", padding: "6px 8px", borderRadius: "8px", background: C.surface, border: "1px solid " + C.border }, children });
}
function MetaLine({ children }) {
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { style: { display: "flex", gap: "6px", alignItems: "baseline", fontSize: "10.5px", lineHeight: "15px", color: C.label3 }, children });
}
function Hint({ children }) {
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { style: { fontSize: "11px", lineHeight: "16px", color: C.label3 }, children });
}

// src/client/agent-events.tsx
var import_jsx_runtime13 = require("react/jsx-runtime");
function toneOf(responder) {
...
function statusRows(s) {
  ...
  rows.push({
    label: "\u8F6E\u8BE2\u515C\u5E95",
    value: p && p.enabled ? "on \xB7 " + p.projects.join(", ") + " \xB7 \u6BCF " + Math.round(p.intervalMs / 1e3) + "s \xB7 \u4E0A\u8F6E " + (p.lastPollAt ? p.lastPollAt.slice(11, 19) + " UTC" : "\u2014") : "off\uFF08agentPollProjects \u4E3A\u7A7A\uFF09"
  });
  rows.push({ label: "ntfy \u63A8\u9001", value: s.ntfy && s.ntfy.enabled ? "on \xB7 " + s.ntfy.url + (s.ntfy.lastError ? " \u26A0 " + s.ntfy.lastError : "") : "off" });
  const r = s.responder;
  rows.push({
    label: "\u81EA\u52A8\u54CD\u5E94",
    value: r && r.enabled ? "on \xB7 \u89E6\u53D1 @" + r.mentionUsername + " \xB7 " + r.maxPerIssuePerHour + " \u6B21/\u65F6" + (r.pipelineTriage ? " \xB7 pipeline \u5206\u8BCA" : "") : "off\uFF08agentMentionUsername \u4E3A\u7A7A\uFF09"
  });
  const o = s.outbound;
  rows.push({
    label: "\u51FA\u7AD9\u8D34\u56DE",
    value: o ? "\u7ED1\u5B9A\u4F1A\u8BDD " + o.boundSessions + " \xB7 \u5DF2\u8D34\u56DE " + o.postedCount + (o.lastTarget ? " \xB7 \u6700\u8FD1 " + o.lastTarget : "") + (o.lastError ? " \u26A0 " + o.lastError : "") : "\u2014",
...
function AgentEventsView() {
  ...
  const [kind, setKind] = (0, import_react10.useState)("");
  const [project, setProject] = (0, import_react10.useState)("");
  const [loading, setLoading] = (0, import_react10.useState)(true);
  const [polling, setPolling] = (0, import_react10.useState)(false);
  const [pollMsg, setPollMsg] = (0, import_react10.useState)(null);
  const load = (0, import_react10.useCallback)(() => {
    const q = new URLSearchParams({ limit: "100" });
    if (kind) q.set("kind", kind);
    if (project.trim()) q.set("project", project.trim());
    fetch("/gitlab-tools/agent-events?" + q.toString(), { cache: "no-store" }).then((r) => r.json()).then((json) => {
      if (json && json.ok === true) {
  ...
  (0, import_react10.useEffect)(() => {
    const t = window.setInterval(load, 15e3);
    return () => window.clearInterval(t);
  }, [load]);
  const onPoll = () => {
    setPolling(true);
    setPollMsg(null);
    fetch("/gitlab-tools/agent-poll", { method: "POST" }).then((r) => r.json()).then((json) => {
      ...
      load();
    }).catch((e) => setPollMsg("\u89E6\u53D1\u5931\u8D25\uFF1A" + String(e && e.message || e))).finally(() => setPolling(false));
  };
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: "10px", minHeight: 0, flex: "1 1 auto", overflowY: "auto" }, children: [
    status ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(StatusCard, { children: statusRows(status).map((row) => /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(StatusRow, { label: row.label, value: row.value, warn: row.warn }, row.label)) }) : /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Hint, { children: loading ? "\u52A0\u8F7D\u4E2D\u2026" : "\u72B6\u6001\u672A\u52A0\u8F7D" }),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { style: { display: "flex", gap: "6px", alignItems: "center" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("select", { value: kind, onChange: (e) => setKind(e.target.value), style: { ...inputStyle, flex: "0 0 110px" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("option", { value: "", children: "\u5168\u90E8\u7C7B\u578B" }),
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("option", { value: "note", children: "note" }),
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("option", { value: "pipeline", children: "pipeline" }),
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("option", { value: "push", children: "push" }),
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("option", { value: "issue", children: "issue" }),
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("option", { value: "merge_request", children: "merge_request" })
      ] }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { style: { display: "flex", gap: "6px", alignItems: "center" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Btn, { onClick: onPoll, disabled: polling, children: polling ? "\u8F6E\u8BE2\u4E2D\u2026" : "\u7ACB\u5373\u8F6E\u8BE2" }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Btn, { onClick: load, children: "\u5237\u65B0" }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(Hint, { children: [
        events.length,
        " / ",
        total,
        " \u6761 \xB7 15s \u81EA\u52A8\u5237\u65B0"
    ...
    pollMsg ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Hint, { children: pollMsg }) : null,
    /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: "4px" }, children: [
      events.length === 0 && !loading ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Hint, { children: "\uFF08\u8FD8\u6CA1\u6709\u4E8B\u4EF6\uFF1A\u7B49 GitLab \u6295\u9012\uFF0C\u6216\u70B9\u300C\u7ACB\u5373\u8F6E\u8BE2\u300D\uFF09" }) : null,
      events.map((e, i) => /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(Row, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(MetaLine, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { children: e.receivedAt ? e.receivedAt.slice(11, 19) : "\u2014" }),
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Badge, { children: e.source }),
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Badge, { children: e.kind }),
          e.skipped ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Badge, { tone: "err", children: "\u767D\u540D\u5355\u5916" }) : null
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { style: { fontSize: "11.5px", lineHeight: "17px", color: C.label1, wordBreak: "break-all" }, children: e.brief }),
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { style: { fontSize: "10.5px", lineHeight: "15px", color: toneOf(e.responder) === "ok" ? C.ok : toneOf(e.responder) === "err" ? C.err : C.label3 }, children: e.responder ? "\u5904\u7F6E\uFF1A" + e.responder : "\u672A\u8FDB\u5165\u54CD\u5E94\u7BA1\u9053" })
      ] }, (e.uuid || String(i)) + (e.receivedAt || "")))
    ] })
  ] });
}
...
function useTabPluginSettings(store) {
  const [value, setValue] = (0, import_react11.useState)({});
  (0, import_react11.useEffect)(() => {
    if (!store || typeof store.getPrefs !== "function") return;
    const update = () => {
      const blob = store.getPrefs().pluginSettings?.["gitlab-tools:issues"];
      const next = {
        defaultProject: typeof blob?.defaultProject === "string" ? blob.defaultProject : void 0,
        refreshMs: typeof blob?.refreshMs === "number" ? blob.refreshMs : void 0
      };
      setValue(
        (prev) => prev.defaultProject === next.defaultProject && prev.refreshMs === next.refreshMs ? prev : next
      );
    };
    update();
    return typeof store.subscribe === "function" ? store.subscribe(update) : void 0;
  }, [store]);
  return value;
}
function GitLabIssuesTab({ ctx, store, scope, visible }) {
  ...
  const [runningById, setRunningById] = (0, import_react11.useState)({});
  const [showSettings, setShowSettings] = (0, import_react11.useState)(false);
  const [showEvents, setShowEvents] = (0, import_react11.useState)(false);
  ...
  const isRunning = (0, import_react11.useCallback)((sessionId) => runningById[sessionId] === true, [runningById]);
  const onOpenSession = (0, import_react11.useCallback)((sessionId) => {
    ctx?.get?.("sessions")?.open?.(sessionId);
  }, [ctx]);
  const onStopSession = (0, import_react11.useCallback)(async (sessionId) => {
    try {
  ...
  const onDevSession = (0, import_react11.useCallback)(
    async (issue) => {
      if (busy) return;
      setBusy(true);
      try {
  ...
  const openNoticeSession = (0, import_react11.useCallback)(() => {
  ...
  if (selected) {
    return /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(IssueDetailView, { project: selected.project, iid: selected.iid, onBack: () => setSelected(null) });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { style: rootPanelStyle, children: [
    /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { style: headerStyle, children: [
      /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("span", { style: { color: C.brand }, children: /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(IssueMark, { size: 14 }) }),
      /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("span", { style: { fontSize: "12.5px", fontWeight: 600, lineHeight: "18px", color: C.label1 }, children: showSettings ? "GitLab Issues \xB7 \u8BBE\u7F6E" : showEvents ? "GitLab Issues \xB7 \u4E8B\u4EF6" : "GitLab Issues" }),
      !showSettings && !showEvents && /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("span", { style: { fontSize: "11px", color: C.label3, fontVariantNumeric: "tabular-nums" }, children: state.loading ? "\u5237\u65B0\u4E2D\u2026" : count }),
      /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("span", { style: { flex: "1 1 auto" } }),
      ...
      !showSettings && /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(
        "button",
        {
          type: "button",
      ...
      !showSettings && !showEvents && /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("button", { type: "button", title: "\u7ACB\u5373\u5237\u65B0", onClick: () => loadIssues(), style: iconBtnStyle, children: "\u27F3" })
    ] }),
    showSettings ? /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(SettingsCard, {}) : showEvents ? /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(AgentEventsView, {}) : /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)(import_jsx_runtime14.Fragment, { children: [
      notice ? /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(DevNoticePanel, { notice, onClose: () => setNotice(null), onOpenSession: openNoticeSession }) : null,
      /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(IssueFilter, { filters, onChange: setFilters }),
      /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(
        IssueList,
        {
          state,
...
var TAB_DESCRIPTOR = {
  ...
  title: "GitLab Issues",
  icon: (size) => /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(IssueMark, { size }),
  order: 60,
  single: true,
