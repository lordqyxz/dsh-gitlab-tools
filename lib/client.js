...
function SettingsCard() {
  const [cfg, setCfg] = (0, import_react.useState)({ defaultProject: "", host: "", token: "", clearToken: false, refreshMs: 12e4 });
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: "12px", maxWidth: "560px" }, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: "11px", lineHeight: "16px", color: C.label3 }, children: "\u670D\u52A1\u5668\u5730\u5740\uFF08host\uFF09\u4E0E\u8BBF\u95EE\u4EE4\u724C\uFF08token\uFF09\u90FD\u53EF\u5728\u6B64\u914D\u7F6E\uFF0C\u4FDD\u5B58\u540E\u7ACB\u5373\u751F\u6548\uFF08\u65E0\u9700\u91CD\u542F\uFF09\u3002 token \u4E3A\u300C\u53EA\u5199\u300D\uFF1A\u4E0D\u56DE\u663E\u660E\u6587\uFF0C\u53EA\u663E\u793A\u662F\u5426\u5DF2\u8BBE\u7F6E\uFF1B\u7559\u7A7A\u4E14\u672A\u52FE\u9009\u300C\u6E05\u9664\u300D\u5219\u4FDD\u6301\u4E0D\u53D8\u3002 \u672A\u8BBE\u7F6E/\u88AB\u6E05\u9664\u65F6\u56DE\u843D profile patch config \u91CC\u7684\u503C\u3002\u4FA7\u8FB9\u680F\u7684 GitLab Issues \u6807\u7B7E\u4F1A\u81EA\u52A8\u5237\u65B0\u3002" }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { style: { display: "flex", flexDirection: "column", gap: "4px", fontSize: "11px", lineHeight: "16px", color: C.label2 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "\u8BBF\u95EE\u4EE4\u724C\uFF08Personal Access Token\uFF1B\u53EA\u5199\u4E0D\u56DE\u663E\uFF09" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "input",
        {
          type: "password",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { style: { display: "flex", alignItems: "center", gap: "6px", fontSize: "11px", lineHeight: "16px", color: C.label2 }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "input",
          {
            type: "checkbox",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "\u6E05\u9664\u5DF2\u4FDD\u5B58\u7684 token\uFF08\u56DE\u843D profile patch config\uFF09" })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { style: { display: "flex", flexDirection: "column", gap: "4px", fontSize: "11px", lineHeight: "16px", color: C.label2 }, children: [
