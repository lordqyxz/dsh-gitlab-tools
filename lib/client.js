...
function SettingsCard() {
  const [cfg, setCfg] = (0, import_react.useState)({ defaultProject: "", refreshMs: 12e4 });
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: "12px", maxWidth: "560px" }, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: "11px", lineHeight: "16px", color: C.label3 }, children: "host/token \u5728 profile patch \u7684 gitlab-tools config \u91CC\u914D\u7F6E\uFF08\u4E0D\u4F1A\u4E0B\u53D1\u5230\u6D4F\u89C8\u5668\uFF09\u3002\u8FD9\u91CC\u53EA\u914D\u7F6E\u9762\u677F\u5C55\u793A\u7528\u9879\uFF0C \u4FDD\u5B58\u540E\u7ACB\u5373\u751F\u6548\uFF08\u65E0\u9700\u91CD\u542F\uFF09\uFF0C\u4FA7\u8FB9\u680F\u7684 GitLab Issues \u6807\u7B7E\u4F1A\u81EA\u52A8\u5237\u65B0\u3002" }),
